...
from .graph import GraphError, ModuleGraph
from .patch import Patch, PatchError, PatchTemplate
...
class SynthEngine:
    ...
    def __init__(self, sample_rate: int = 48000, buffer_size: int = 1024):
        ...
        self.current_patch: Patch | None = None
        self.current_graph: ModuleGraph | None = None
        self._processing_callbacks: list[Callable] = []
        self._context: SynthContext | None = None
    ...
    def load_patch(self, patch_file: str | Path,
                   variables: dict[str, Any] | None = None) -> Patch:
        """
    ...
    @performance_logger
    def render(self, duration: float | None = None,
               output_file: str | Path | None = None,
               progress_callback: Callable[[float], None] | None = None) -> np.ndarray:
        """
    ...
    def save_audio(self, filename: str | Path, audio_data: np.ndarray,
    ...
    def create_template(self, template_file: str | Path) -> 'PatchTemplate':
        """

...
def main():
    parser = argparse.ArgumentParser(description="RNBO Analog Oscillator Demo")
    parser.add_argument("--output", type=str, default="../audio/rnbo_analog.wav", help="Output WAV file path")
    ...
    print(f"Initializing RNBO Oscillator (mode={args.mode}) and ADSR Envelope...")
    osc = RNBOOscillator(sample_rate=args.sample_rate, mode=args.mode)

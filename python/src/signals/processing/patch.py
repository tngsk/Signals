...
class SequenceEvent:
    ...
    def __init__(self, time: float, action: str, target: str, params: dict | None = None):
        self.time = time
        self.action = action
        self.target = target
...
class PatchTemplate:
    ...
    def get_variable_schema(self) -> dict[str, Any]:
        ...
        try:
            ...
            return dict.fromkeys(self.variables)

    def instantiate(self, variables: dict[str, Any] | None = None) -> 'Patch':
        """
...
class Patch:
    ...
    @classmethod
    def from_file(cls, patch_file: str | Path) -> 'Patch':
    ...
    def from_dict(cls, patch_data: dict[str, Any],
                  source_file: Path | None = None) -> 'Patch':

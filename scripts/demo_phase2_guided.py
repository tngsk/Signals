...
try:
    from signals import ModuleGraph, Patch, PatchTemplate, SynthEngine
    from signals.processing.engine import EngineError
    from signals.processing.patch import Connection, PatchError, SequenceEvent
